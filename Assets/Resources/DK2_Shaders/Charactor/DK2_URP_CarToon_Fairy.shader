Shader "DK2_URP_Shader/Charactor/CarToon_Fairy"
{
    Properties
    {
           ...
           #pragma multi_compile _ _MAIN_LIGHT_SHADOWS _MAIN_LIGHT_SHADOWS_CASCADE
            ...
            tOUTPUT_Base vert_Main( tINPUT_Full tIn )
			{
               ...
               tOut.worldPos  = TransformObjectToWorld( tIn.vertex.xyz );
                ...
                float3 lightposoffset= _WorldSpaceCameraPos.xyz  ;
				tOut.f3EyeW     = normalize( lightposoffset.xyz - (tOut.worldPos.xyz +_LightDirection.xyz));
            ...
            float4 frag_Main( tOUTPUT_Base tIn ) : SV_Target
			{
                ...
                float3 height =   tIn.height  - 1 +_DssvAmount * 4 ;
              ...
              float3 Addlightcolor = float3(0,0,0);
				...
				for (uint lightIndex = 0u; lightIndex < pixelLightCount; ++lightIndex)
				{
					...
					Addlightcolor += addLight.color.rgb  *  distance ;
               ...
               float3	f3Ramp		= Calc_RampColor( f4RampTex.rgb *_RampC.rgb  , fNDotL *  MaskTex.r * 2, 0.25f,1) ;
                ...
                float3  aniSpcColor = anistoSpecColor( _MainLightPosition.xyz, tIn.f3NormalW, _Normal.xyz , _AnisoDir.xyz, _AnisoOffset, _Gloss, _SpecularITS, f4MainTex.rgb , MaskTex,_SpecularRange, f3Ramp.rgb);
                ...
                //Result
				float3	f3Result	=(( f4MainTex.rgb * f3Ramp ).rgb + f3RimColor *f4MainTex.rgb) + finalspec;
