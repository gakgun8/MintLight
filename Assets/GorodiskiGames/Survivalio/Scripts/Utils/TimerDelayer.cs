...
namespace Game.Utilities
{
    public class TimerDelayer : IDisposable
    {
        ...
        private class DelayItem<T0,T1,T2> : IDelayItem
        {
            public float ActionTime { get; private set; }
            ...
            public DelayItem(float delay, Action<T0, T1, T2> action, object argument0, object argument1, object argument2)
            {
                ActionTime = Time.time + delay;
                _action = action;
                _argument0 = argument0;
            ...
            public void SafeInvoke()
            {
                if (null != _action)
                {
                    _action.Invoke((T0)_argument0, (T1)_argument1, (T2)_argument2);
                }
            }
        }
        ...
        public void DelayAction<T0, T1, T2>(float delay, Action<T0, T1, T2> action, object arg0, object arg1, object arg2)
        {
            _items.Add(new DelayItem<T0, T1, T2>(delay, action, arg0, arg1, arg2));
        }
